...
func Decode(b []byte, comboMode bool) (res Keycodes, isCombo bool, isExit bool) {
	if len(b) == 1 {
	...
	if comboMode {
		...
		return res, false, res == Keycodes{K_L_CTRL, K_Q}
	} else {
		return res, res == Keycodes{K_L_CTRL, K_K}, false
	}
}
